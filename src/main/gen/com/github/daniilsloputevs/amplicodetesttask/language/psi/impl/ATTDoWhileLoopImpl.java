...
public class ATTDoWhileLoopImpl extends ASTWrapperPsiElement implements ATTDoWhileLoop {

  public ATTDoWhileLoopImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public ATTBlock getBlock() {
    return findNotNullChildByClass(ATTBlock.class);
  }

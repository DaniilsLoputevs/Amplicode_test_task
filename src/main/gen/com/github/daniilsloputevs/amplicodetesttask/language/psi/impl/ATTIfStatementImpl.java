...
public class ATTIfStatementImpl extends ASTWrapperPsiElement implements ATTIfStatement {

  public ATTIfStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ATTBlock> getBlockList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ATTBlock.class);
  }

  @Override
  @NotNull
  public ATTExpression getExpression() {
    return findNotNullChildByClass(ATTExpression.class);
  }

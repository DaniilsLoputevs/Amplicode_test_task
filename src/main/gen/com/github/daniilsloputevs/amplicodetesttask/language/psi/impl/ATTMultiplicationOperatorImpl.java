...
public class ATTMultiplicationOperatorImpl extends ASTWrapperPsiElement implements ATTMultiplicationOperator {

  public ATTMultiplicationOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ATTVisitor visitor) {
    visitor.visitMultiplicationOperator(this);
  }

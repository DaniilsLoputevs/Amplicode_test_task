...
public class ATTVariableDeclarationImpl extends ASTWrapperPsiElement implements ATTVariableDeclaration {

  public ATTVariableDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

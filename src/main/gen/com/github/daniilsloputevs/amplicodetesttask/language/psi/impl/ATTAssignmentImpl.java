...
public class ATTAssignmentImpl extends ASTWrapperPsiElement implements ATTAssignment {

  public ATTAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public ATTIdentifier getIdentifier() {
    return findNotNullChildByClass(ATTIdentifier.class);
  }

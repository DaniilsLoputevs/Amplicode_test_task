...
public class ATTStatementListImpl extends ASTWrapperPsiElement implements ATTStatementList {

  public ATTStatementListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ATTStatement> getStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ATTStatement.class);
  }

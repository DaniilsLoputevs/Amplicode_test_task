...
public class ATTComparisonOperatorImpl extends ASTWrapperPsiElement implements ATTComparisonOperator {

  public ATTComparisonOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
